...
@Slf4j
public class GuestCountByPeriodWithHotelController {
    private final GuestService guestService;
    private final ObjectMapper objectMapper;
    private final DateFormatter dateFormatter;

    @GetMapping({"/guestCountByPeriodWithHotel"})
    public ModelAndView guestCountByPeriodWithHotel() {
        ModelAndView modelAndView = new ModelAndView();
        modelAndView.setViewName("guestCountByPeriodWithHotel");
    ...
    @PostMapping("/guestCountByPeriodWithHotel")
    public String guestCountByPeriodWithHotel(@ModelAttribute("guestRequest") GuestRequest guestRequest, Model model) {
        ...
        try {
            ...
            guestList = guestService.guestCountByPeriodWithHotel(
